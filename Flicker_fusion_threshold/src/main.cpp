...
volatile long lastDebounceTime = 0; // output pin previous toggle recorded
volatile long debounceDelay = 50; // debounce delay time
//Its given to filter out unwanted switch bounces.
float time; // to store the value of 'Timeperiod' 
...
void ISR() // Created Interrupt Service Routine (ISR)
{
bool flag;
